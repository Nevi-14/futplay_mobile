...
export class SeleccionarFechaPage {
  ...
  meses = [
    { id: 'Enero', valor: 'Enero' },
    { id: 'Febrero', valor: 'Febrero' },
    { id: 'Marzo', valor: 'Marzo' },
    { id: 'Abril', valor: 'Abril' },
    { id: 'Mayo', valor: 'Mayo' },
    { id: 'Junio', valor: 'Junio' },
    { id: 'Julio', valor: 'Julio' },
    { id: 'Agosto', valor: 'Agosto' },
    { id: 'Septiembre', valor: 'Septiembre' },
    { id: 'Octubre', valor: 'Octubre' },
    { id: 'Noviembre', valor: 'Noviembre' },
    { id: 'Diciembre', valor: 'Diciembre' },
  ];
  dias = [];
  anos = [];
  ...
  ionViewWillEnter() {
    ...
    this.dateObjectReturn.month = this.capitalizeFirstLetter(
      this.today.toLocaleString('es-ES', { month: 'long' })
    );
  ...
  populateDays(fFecha: NgForm, event?) {
    ...
    this.dias = [];
    let monthValue = fFecha.value.mes
      ? fFecha.value.mes
      : this.dateObjectReturn.month;
    ...
    for (let i = 1; i <= numeroDias; i++) {
      this.dias.push({ id: String(i), valor: i });
  ...
  seleccionarFecha(fFecha: NgForm) {
    ...
    let completeDate = new Date(
      fecha.ano,
      this.meses.findIndex((e) => e.id == fecha.mes),
      fecha.dia
    );
