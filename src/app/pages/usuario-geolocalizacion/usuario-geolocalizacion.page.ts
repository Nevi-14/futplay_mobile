...
export class UsuarioGeolocalizacionPage implements OnInit {
  ...
  ngOnInit() {
    ...
    this.geolocalizacionService.Codigo_Pais =
      this.usuarioGeolocalizacion.Codigo_Pais;
    this.geolocalizacionService.Codigo_Estado =
      this.usuarioGeolocalizacion.Codigo_Estado;
    this.geolocalizacionService.Codigo_Ciudad =
      this.usuarioGeolocalizacion.Codigo_Ciudad;
  ...
  actualizar(form: NgForm) {
    this.alertasService.presentaLoading(
      this.translateService.instant('UPDATING')
    );
    this.usuariosGeolocacionService
      .syncPutUsuarioGeolocalizacionToPromise(this.usuarioGeolocalizacion)
      .then(
        () => {
