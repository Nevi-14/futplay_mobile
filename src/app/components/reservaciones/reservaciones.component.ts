...
export class ReservacionesComponent implements OnInit {
  ...
  constructor(  public retosService: ReservacionesService, public clubs: EquiposService, public opcionesService: OpcionesService, public modalCtrl: ModalController) { }
