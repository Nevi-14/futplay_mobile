...
Cod_Dia INT IDENTITY(1,1)  NOT NULL,
Nombre VARCHAR(30) NOT NULL,
CONSTRAINT PK_DIAS_SEMANA_COD_DIA PRIMARY KEY (Cod_Dia)
...
CONSTRAINT FK_HORARIO_CANCHA_COD_DIA FOREIGN KEY (Cod_Dia) REFERENCES DIAS_SEMANA (Cod_Dia),
...
Fecha DATE NOT NULL,
CONSTRAINT PK_JUGADORES_FAVORITOS_COD_FAVORITO PRIMARY KEY (Cod_Favorito),
CONSTRAINT FK_JUGADORES_FAVORITOS_COD_USUARIO FOREIGN KEY (Cod_Usuario) REFERENCES USUARIOS (Cod_Usuario),
CONSTRAINT FK_JUGADORES_FAVORITOS_COD_JUGADOR FOREIGN KEY (Cod_Usuario) REFERENCES JUGADORES_EQUIPOS (Cod_Jugador)
...
Confirmacion_Retador BIT,
Confirmacion_Rival BIT,
Estado BIT,
