...
Telefono VARCHAR (60) NOT NULL UNIQUE,
...
Cod_Canton INT  NOT NULL,
Cod_Distrito INT  NOT NULL,
CONSTRAINT FK_DETALLE_USUARIO_COD_DETALLE PRIMARY KEY (Cod_Detalle),
CONSTRAINT FK_DETALLE_USUARIO_COD_USUARIO  FOREIGN KEY (Cod_Usuario) REFERENCES USUARIOS (Cod_Usuario),
CONSTRAINT FK_DETALLE_USUARIO_COD_PROVINCIA  FOREIGN KEY (Cod_Provincia) REFERENCES PROVINCIAS (Cod_Provincia),
CONSTRAINT FK_DETALLE_USUARIO_COD_CANTON  FOREIGN KEY (Cod_Canton) REFERENCES Cantones (Cod_Canton),
CONSTRAINT FK_DETALLE_USUARIO_COD_DISTRITO  FOREIGN KEY (Cod_Distrito) REFERENCES Distritos (Cod_Distrito),
)
...
Fecha DATE  NOT NULL,
Hora_Inicio DATETIME  NOT NULL UNIQUE, 
Hora_Fin DATETIME  NOT NULL UNIQUE, 
