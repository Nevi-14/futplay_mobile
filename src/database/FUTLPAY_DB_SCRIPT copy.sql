...
GO
CREATE TABLE Excepciones_Horario_Canchas (
Cod_Excepcion INT IDENTITY(1,1)  NOT NULL,
Cod_Cancha INT NOT NULL,
Fecha DATE NOT NULL,
Hora_Inicio DATETIME NOT NULL,
Hora_Fin DATETIME NOT NULL,
CONSTRAINT PK_EXCEPCIONES_HORARIO_CANCHAS_COD_EXCEPCION PRIMARY KEY (Cod_Excepcion),
CONSTRAINT FK_EXCEPCIONES_HORARIO_CANCHAS_COD_CANCHA FOREIGN KEY (Cod_Cancha) REFERENCES CANCHAS (Cod_Cancha)
...
Dureza_Rival VARCHAR (60),
Dureza_Retador VARCHAR (60),
...
Jugador_Futplay BIT,
Jugador_Del_Partido BIT,
CONSTRAINT PK_HISTORIAL_PARTIDOS_JUGADOR_COD_HISTORIAL PRIMARY KEY (Cod_Historial),
CONSTRAINT FK_HISTORIAL_PARTIDOS_JUGADOR_COD_PARTIDO FOREIGN KEY (Cod_Partido) REFERENCES HISTORIAL_PARTIDOS (Cod_Partido),
CONSTRAINT FK_HISTORIAL_PARTIDOS_JUGADOR_COD_JUGADOR FOREIGN KEY (Cod_Jugador) REFERENCES JUGADORES_EQUIPOS (Cod_Jugador)
